 ...
 */
public class GetFragmentArgAction extends FragmentAction {
    ...
    @Override
    public void processFragmentAction(@Nullable Fragment fragment, @Nullable androidx.fragment.app.Fragment supportFragment, @NonNull String data, @NonNull ResultData result) {
        Bundle bundle = null;
        if (fragment != null) {
