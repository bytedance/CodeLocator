...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
    ...
    public void setWidthProvider(WidthProvider mWidthProvider) {
        this.mWidthProvider = mWidthProvider;
    }
    ...
    public void adjustColumn(final int column) {
        ...
        if (column == 1) {
            final int width = mWidthProvider == null ? CoordinateUtils.PANEL_WIDTH : mWidthProvider.getWidth();
            final int remainWidth = width - table.getColumnModel().getColumn(0).getWidth();
            preferredWidth = Math.max(remainWidth, preferredWidth);
        }
