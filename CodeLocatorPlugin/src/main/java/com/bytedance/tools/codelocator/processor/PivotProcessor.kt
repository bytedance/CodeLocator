...
import com.bytedance.tools.codelocator.model.EditPivotModel
...
class PivotProcessor(project: Project, view: WView) : ViewValueProcessor(project, "Pivot", view) {

    override fun getShowValue(view: WView): String {
        return "${view.pivotX}, ${view.pivotY}"
    }

    override fun getHint(view: WView): String {
        return ResUtils.getString("edit_pivot_tip")
    }
    ...
    override fun getChangeModel(view: WView, changeString: String): EditModel? {
        ...
        return EditPivotModel(values[0], values[1])
    }
