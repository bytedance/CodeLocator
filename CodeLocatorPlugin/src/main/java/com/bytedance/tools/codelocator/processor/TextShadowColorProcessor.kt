...
import com.bytedance.tools.codelocator.model.EditShadowColorModel
import com.bytedance.tools.codelocator.utils.ResUtils
import com.intellij.openapi.project.Project
import java.util.regex.Pattern

class TextShadowColorProcessor(project: Project, view: WView) : ViewValueProcessor(project, "ShadowColor", view) {

    override fun getHint(view: WView): String {
        return ResUtils.getString("edit_color_tip")
    }

    override fun getShowValue(view: WView): String = view.shadowColor
    ...
    override fun getChangeModel(view: WView, changeString: String): EditModel? {
        ...
        return EditShadowColorModel(colorStr.toLong(16).toInt())
    }
}